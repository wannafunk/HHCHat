...
class PlaceholderTextView: UITextView {
    ...
    private enum Constants {
        ...
        static let defaultInputTextViewHeight: CGFloat = 40
    ...
    private var currentInputTextViewHeight: CGFloat = 40
    var placeholder: String = "" {
        didSet {
            placeholderLabel.setStyle(with: placeholder, style: TextStyle.PlaceholderStyle.Label.textStyle)
        }
    }
